    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
        ...
        @media (prefers-color-scheme: dark) { 
            body { background: var(--bg-dark); color: var(--text-primary-dark); } 
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .app-header { background: var(--card-bg-dark); border-bottom: 1px solid var(--border-dark); } 
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .nav-btn.active { background: var(--card-bg-dark); color: var(--accent-dark); box-shadow: 0 2px 6px rgba(0,0,0,0.2); } 
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .time-badge { background: var(--accent-soft-dark); color: var(--accent-dark); } 
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .task-card, .note-card, .history-date-card { background: var(--card-bg-dark); border: 1px solid var(--border-dark); } 
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .task-description { color: var(--text-secondary-dark); background: var(--hover-dark); } 
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .date-chip, .time-chip { background: var(--hover-dark); color: var(--text-secondary-dark); } 
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .action-btn { background: var(--hover-dark); color: var(--text-secondary-dark); } 
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .subtask-description { background: var(--card-bg-dark); color: var(--text-secondary-dark); } 
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .note-content { color: var(--text-secondary-dark); background: var(--hover-dark); } 
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .note-meta { border-top-color: var(--border-dark); color: var(--text-secondary-dark); } 
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .month-btn { background: var(--card-bg-dark); border-color: var(--border-dark); color: var(--text-primary-dark); } 
        }
        ...
        .history-details summary {
            ...
            width: 100%;
            cursor: pointer;
            list-style: none; /* Removes standard browser arrow if possible */
        }
        .history-details summary::-webkit-details-marker {
            display: none; /* Removes standard browser arrow in Webkit */
        }
        .history-details summary i.fa-calendar-alt {
            margin-right: 8px; /* Added gap between icon and date */
            color: var(--accent-light);
        }
        @media (prefers-color-scheme: dark) {
            .history-details summary i.fa-calendar-alt { color: var(--accent-dark); }
        }
        ...
        @media (prefers-color-scheme: dark) { 
            .history-description { background: var(--card-bg-dark); color: var(--text-secondary-dark); } 
        }
        ...
        function renderHistoryPage() {
            ...
            if (dates.length === 0) {
                ...
                dates.forEach(date => {
                    ...
                    // Fixed alignment for Date Icon and Tasks Count Badge
    ...
    try {
        ...
        for (const task of pendingTasks) {
            ...
            if (task.repeat !== 'none' && task.repeatCount > 0) {
                ...
                if (updatedTask && updatedTask.nextOccurrence > new Date()) scheduleTask(updatedTask);
            } else {
...
// TASK CREATION: COMPLETELY REMOVED THE 10 MINUTE LIMIT 
...
// TASK EDITING: COMPLETELY REMOVED THE 10 MINUTE LIMIT
app.post('/api/tasks/:taskId/update', async (req, res) => {
    try {
        ...
        // ONLY RESTRICTION NOW: End time must be after Start time
        if (!startDateUTC || endDateUTC <= startDateUTC) {
            return res.status(400).send('End time must be after start time.');
        }
