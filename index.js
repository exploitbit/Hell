...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: system-ui, sans-serif; }
        ...
        /* Newly Rewritten Perfect 1:1 Flexible Calendar CSS */
        .calendar { width: 100%; aspect-ratio: 1 / 1; display: flex; flex-direction: column; }
        .grid { flex: 1; width: 100%; display: grid; grid-template-columns: repeat(7, minmax(0, 1fr)); grid-template-rows: auto repeat(6, minmax(0, 1fr)); gap: 4px; }
        ...
        /* Enforces perfect circles, completely prevents stretching/overflow */
        .circle { 
            width: 100%; 
            max-width: 36px; 
            aspect-ratio: 1 / 1; 
